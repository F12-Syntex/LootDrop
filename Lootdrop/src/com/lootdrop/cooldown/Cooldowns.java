...
import com.lootdrop.placeholder.time.TimeData;
import com.lootdrop.utils.MappyHelper;
import com.lootdrop.utils.MappyObject;

public class Cooldowns {

	public static Cooldowns instance;
	
	public FileConfiguration config = Lootdrop.getInstance().configManager.getConfig("cooldown").configuration;
